...
a persistence unit "ServidorCamasWilmerPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ServidorCamasWilmer\pom.xml":
...
artifact ("ServidorCamasWilmer.war") is already built. You can build
